    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex justify-between items-center mb-4 sticky top-0 bg-white py-4 z-10">
                ...
                <button className="form-button" onClick={handleSaveSiteConfig}>Simpan Perubahan</button>
            </div>
            
            <div className="flex border-b mb-4">
                <button onClick={() => setActiveTab('general')} className={`py-2 px-4 text-sm font-medium ${activeTab === 'general' ? 'border-b-2 border-kazumi-black text-kazumi-black' : 'text-gray-500'}`}>Halaman Utama</button>
