            ...
            <div className="form-container" style={{ maxWidth: '900px' }}>
                {isMobileView ? (
                    <div className="form-group mb-6">
                        <label htmlFor="profile-nav" className="form-label">Navigasi Profil</label>
                        <select
                            id="profile-nav"
                            value={activeTab}
                        ...
                        >
                            <option value="profile">Profil Saya</option>
                            <option value="history">Riwayat Pesanan</option>
                            <option value="warranty">Hasil Claim Garansi</option>
                            <option value="messages">Pesan Masuk {unreadCount > 0 ? `(${unreadCount})` : ''}</option>
                        </select>
                    </div>
                ) : (
