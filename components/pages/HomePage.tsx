                    ...
                    <div key={index} className={`slide ${index === currentSlide ? 'active' : ''}`}>
                        <div className="slide-content">
                            ...
                            <div className="slide-image">
                                <img src={slide.img.url} alt="Hero image" style={{ objectPosition: slide.img.position }} />
                            </div>
                        </div>
                    </div>
                ))}
                    ...
                    <div className="categories-grid">
                        {siteConfig?.popularCategories.map((category, index) => (
                             <Link to={category.link} className="category-card" key={index}>
                                <img src={category.image.url} alt={category.title} style={{ objectPosition: category.image.position }} />
                    ...
                    <div className="collection-grid">
                         {siteConfig?.specialCollections.map((collection, index) => (
                            <Link to={collection.link} className="collection-card" key={index}>
                                <img src={collection.image.url} alt={collection.title} style={{ objectPosition: collection.image.position }} />
